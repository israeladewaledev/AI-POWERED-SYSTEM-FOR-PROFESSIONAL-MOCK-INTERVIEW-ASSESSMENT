#!/usr/bin/env python3
"""
Script to extract literature review information from PDF papers in Firdausi batch 1
...
# Process batch 1 papers
batch1_files = [
    '10.17718-tojde.1335062-3296886.pdf',
    '125988935.pdf',
    '1661-IKOMTI-48-55.pdf',
    '2024-2025-MolMManuel.pdf',
    '2025.latechclfl-1.17.pdf',
    '2407.06125v2.pdf',
    '2512.12240v1.pdf',
    '277d8a4ae8b9e907b7a9733617b6c1a47300.pdf',
    '3572549.3572629.pdf',
    '8-ASR+Capcut,+Netaniel+English_Revision2.pdf'
]

print("Processing Firdausi Batch 1 papers (Speech to Text focus)...")
...
print("\nFirdausi Batch 1 processing complete!")
