#!/usr/bin/env python3
"""
Script to extract literature review information from PDF papers in Firdausi batch 2
...
batch2_files = [
    'A systematic literature review of research on automatic speech recognition in EFL pronunciation.pdf',
    'A_Model_for_the_Application_of_Automatic.pdf',
    'Dai_Mobile-assisted_Pronunciation_Learning.pdf',
    'download.pdf',
    'Effects-of-Automatic-Speech-Recognition-Technology-on-EFL-Learners-Willingness-to-Communicate-and-Interactional-Features.pdf',
    'EJ1331340.pdf',
    'EJ1438371.pdf',
    'Enhancing_User_Research_by_Employing_Artificial_Intelligence_Designing_and_evaluating_a_method_for_.pdf',
    'Exploring-the-effects-of-automatic-speech-recognition-technology-on-oral-accuracy-and-fluency-in-a-flipped-classroom.pdf',
    'fpsyg-13-1049139.pdf'
]

print("Processing Firdausi Batch 2 papers (Speech to Text focus)...")
...
print("\nFirdausi Batch 2 processing complete!")
