#!/usr/bin/env python3
"""
Enhanced script to extract detailed information from PDF papers for Batch 2
...
def create_batch_document(papers_info, batch_number=2):
...
"""
    ...
    for paper in background_papers[:5]:
...
"""
    ...
    for paper in methodology_papers[:8]:
        authors = paper.get('authors', 'Unknown')
        year = paper.get('year', 'n.d.')
...
"""
    ...
    for paper in limitation_papers[:15]:
        authors = paper.get('authors', 'Unknown')
        year = paper.get('year', 'n.d.')
...
"""
    ...
    for paper in findings_papers[:5]:
        authors = paper.get('authors', 'Unknown')
        year = paper.get('year', 'n.d.')
...
# Process batch 2 papers (papers 16-30)
batch2_files = [
    'Alhaji4012024JAMCS128845.pdf',
    'An Efficient Approach for Phishing Detection using Machine Learning.pdf',
    'Article.pdf',
    'Challenges-of-Data-Collection-and-Preprocessing-for-Phishing-Email-Detection.pdf',
    ...
    'Detection Technique and Mitigation against A Phishing Attack.pdf',
    'FULLTEXT01.pdf',
    'Hawa_Apandi_2020_IOP_Conf._Ser.__Mater._Sci._Eng._769_012072.pdf',
    'krisana,+240565.pdf',
    'Microsoft Word - 176462020013989Machine...shing A Review for Promises and Challe.pdf',
    'peerj-cs-2131.pdf',
    'Phishing Detection Using Machine Learning Technique.pdf',
    'Phishing URL detection using machine learning methods.pdf',
    's10462-024-11055-z.pdf'
]

if __name__ == "__main__":
    print("Processing Lameer Batch 2 papers (15 papers)...")
    ...
    batch_doc = create_batch_document(papers_info, batch_number=2)
    
    # Save to file
    output_file = os.path.join(os.path.dirname(__file__), 'BATCH 2.md')
