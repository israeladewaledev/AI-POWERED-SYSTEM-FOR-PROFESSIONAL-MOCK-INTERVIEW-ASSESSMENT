#!/usr/bin/env python3
"""
Script to extract literature review information from PDF papers in batch 3
"""
import PyPDF2
import re
import os
...
batch3_files = [
    'AI-Based-Remote-Assessment-of-Depression-in-Humans-A-Pathway-to-Enhancing-Food-and-Job-Security-for-Poverty-Reduction-in-Nigeria.pdf',
    'biron-et-al-2025-disentanglement-of-prosodic-meaning-toward-a-framework-for-the-analysis-of-nonverbal-information-in.pdf',
    'Emotionally-Intelligent-AI-Systems-for-Neurodiverse-Environments-Enhancing-Engagement-Through-Contextual-and-Behavioral-Awareness.pdf',
    'IRJET_Automated_HR_Interview_System.pdf',
    'kthompson1,+[7]+6798-Article+Text-22348-1-11-20210212.pdf',
    'Mental+Health+Analysis+Using+Machine+Learning.pdf',
    'Multimodal_Transfer_Learning_for_Oral_Presentation_Assessment.pdf',
    'out.pdf',
    'Personality_Recognition_and_Video_Interv.pdf',
    'phd_unimib_836548.pdf',
    'Real-Time-Mock-Interview-Evaluation-using-CNN.pdf',
    's10462-024-10760-z.pdf',
    's41598-025-19141-0.pdf',
    'ssrn-4946523.pdf',
    'ssrn-5412377.pdf',
    'The-Second-National-Conference-on-Human-Computer-Interaction-Theories-and-Applications-Beyond-the-Chatbots-Designing-Multi-Modal-Interactive-Systems-for-Developing-Socio-Pragmatic-Competence-in-Async.pdf',
    'USING DEEP LEARNING-BASED FRAMEWORK FOR CHILD SPEECH EMOTION RECO.pdf',
    'WMRB2020.pdf'
]

print("Processing Batch 3 papers...")
