...
def parse_extraction_files():
    files = glob.glob("/Users/goddaffi/Desktop/Final Year Projects/Maryam/Maryam Literature/*-Extraction.md")
    fact_sheet = []
    ...
    with open("maryam_chapter_two_fact_sheet.txt", "w", encoding="utf-8") as out:
